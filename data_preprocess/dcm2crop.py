...
if __name__ == '__main__':
    ...
    to_dir = './tmpset'
    csv = "/home/DL/ModelFeast/data/train_label.csv"
    process_dataset(from_dir, to_dir, csv)

    # folder = '0A2E9075-5C56-4E0D-AA2F-383002345D7C'
    # old_folder = os.path.join('/home/DL/ModelFeast/data/train_dataset', folder)
    # new_folder = os.path.join('./tmpset', folder)
    # dcm2png_dir(old_folder, new_folder, verbose=True)
