...
class WideResNet(nn.Module):
    ...
    def __init__(self,
        ...
        base = first_features
        nStages = [base*k, base*2*k, base*4*k, base*8*k]
        self.layer1 = self._make_layer(block, nStages[0], layers[0], shortcut_type)
        self.layer2 = self._make_layer(
            block, nStages[1], layers[1], shortcut_type, stride=2)
        self.layer3 = self._make_layer(
            block, nStages[2], layers[2], shortcut_type, stride=2)
...
if __name__ == '__main__':
    a = 64
    img_size=(a, a)
    model = c1wideresnet50_3d(n_classes=2, in_channels=1)
